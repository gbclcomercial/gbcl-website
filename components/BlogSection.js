  ...
  return (
    <section id="blog" className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold text-blue-900 mb-4">Boletines Informativos GBC Auditores</h2>
        <p className="text-gray-600 mb-8 max-w-3xl">En esta sección encontrará nuestros boletines informativos anuales con novedades contables, tributarias y de auditoría, elaborados por el equipo de GBC Auditores.</p>
